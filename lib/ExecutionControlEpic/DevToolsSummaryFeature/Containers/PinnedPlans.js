...
export function mapDispatchToProps(
  ...
  return {
    onToolSettingsClick: (devtool: DevToolWithDiagnosticsType) => {
      console.log("onToolSettingsClick");
    },
    onToolLogsClick: (devtool: DevToolWithDiagnosticsType) => {
      if (devtool.plan.state == "running") {
        dispatch(killTask(devtool.plan));
        devtool.plan.state = "stopped";
      } else {
        devtool.plan.state = "running";
    ...
    onToolDiagnosticsClick: (
      ...
      console.log("onToolDiagnosticsClick");
    },
  };
}
