...
export default function PlanConfigurer(props: Props = { packages: [] }) {
  return (
    <ConfigurerBox>
      <PlanConfigTextInputField label="name" name="name" />
      <SectionTitle>Action</SectionTitle>
      <PlanConfigPart {...props.config} name="config" />
      ...
      <PackageConfig name="packageInfos" packages={props.packages} />
      ...
      <ButtonPositioner>
        <AddButton onClick={props.onSubmit} success>
          Create
        </AddButton>
      </ButtonPositioner>
    </ConfigurerBox>
